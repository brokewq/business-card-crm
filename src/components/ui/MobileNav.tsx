    ...
    return (
        <nav className="fixed bottom-0 left-0 right-0 z-40 bg-white/95 backdrop-blur-lg border-t border-clay-border pb-safe shadow-clay-lg">
            <div className="grid grid-cols-3 items-end py-2">
                ...
                >
                    <Users
                        className={`w-6 h-6 mb-1 ${pathname === '/contacts' ? 'text-accent-500 fill-accent-50' : 'text-gray-400 group-hover:text-navy-700'}`}
                ...
                >
                    <Building2
                        className={`w-6 h-6 mb-1 ${pathname === '/companies' ? 'text-accent-500 fill-accent-50' : 'text-gray-400 group-hover:text-navy-700'}`}
